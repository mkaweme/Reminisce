    ...
    <View style={styles.container}>
      ...
      <View style={styles.imagesContainer}>
        ...
        <View style={styles.imageContainer}>
          ...
          />
          <TouchableOpacity 
            style={styles.cameraIcon} onPress={async () => setImage_2(await pickImage())}
          >
            <MaterialCommunityIcons name="camera-plus-outline" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.imageContainer}>
          ...
          />
          <TouchableOpacity 
            style={styles.cameraIcon} onPress={async () => setImage_3(await pickImage())}
          >
            <MaterialCommunityIcons name="camera-plus-outline" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.imageContainer}>
          ...
          />
          <TouchableOpacity 
            style={styles.cameraIcon} onPress={async () => setImage_4(await pickImage())}
          >
            <MaterialCommunityIcons name="camera-plus-outline" size={20} color="white" />
          </TouchableOpacity>
        </View>
